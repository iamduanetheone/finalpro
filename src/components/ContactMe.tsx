...
export default function ContactMe() {
  ...
  const { 
    ...
    defaultValues: {
      ...
      budget: '',
      message: '',
      access_key: process.env.NEXT_PUBLIC_WEB3FORMS_ACCESS_KEY || 'YOUR_FALLBACK_ACCESS_KEY',
      subject: 'New Contact Form Submission from Duane Copywriter Website',
      from_name: 'Duane Copywriter Website',
    },
  });
  
  useEffect(() => {
    if (!process.env.NEXT_PUBLIC_WEB3FORMS_ACCESS_KEY) {
      console.error('CRITICAL: NEXT_PUBLIC_WEB3FORMS_ACCESS_KEY is not set in environment variables. Form submissions will likely fail.');
      // Optionally, you could set an error state here to inform the user on the UI
    }
  }, []);
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-slate-800">
            Let&apos;s Achieve Your <span className="text-sky-600">Academic & Career Goals</span>
          </h2>
          <p className="text-center text-xl text-slate-600 mb-12 max-w-2xl mx-auto">
            Ready to elevate your academic performance or advance your career? Our expert team is here to help you succeed.
          </p>
        </motion.div>
          ...
          <div className="grid md:grid-cols-5 gap-8">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:iamduanecarter@gmail.com" className="text-white hover:text-sky-200 transition-colors">
                      iamduanecarter@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="tel:+19736927346" className="text-white hover:text-sky-200 transition-colors">
                      +1 (973) 692-7346
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="https://twitter.com/academicexcellence" target="_blank" rel="noopener noreferrer" className="text-white hover:text-sky-200 transition-colors" aria-label="Twitter">
                  ...
                  <a href="https://www.linkedin.com/company/academicexcellence" target="_blank" rel="noopener noreferrer" className="text-white hover:text-sky-200 transition-colors" aria-label="LinkedIn">
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            >
              ...
              <form onSubmit={handleSubmit(onSubmit, onInvalidSubmit)} className="space-y-6">
                ...
                <div>
                  <label htmlFor="company" className="block text-sm font-medium text-slate-700 mb-1">Institution / Company</label>
                  <input 
                    id="company" 
                ...
                <div>
                  <label htmlFor="projectType" className="block text-sm font-medium text-slate-700 mb-1">Service Type</label>
                  <select 
                    id="projectType" 
                  ...
                  >
                    ...
                    <option value="essay-assignment">Essay/Assignment</option>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    placeholder="Tell us about your academic or career needs..."
                    {...register('message')}
                  ></textarea>
                  {errors.message && (
