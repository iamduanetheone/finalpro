...
const processSteps: ProcessStep[] = [
  {
    ...
    description: "We start with a deep dive into your business, goals, target audience, and current SEO landscape. Understanding your needs is key.",
    details: "During this phase, I'll conduct a thorough review of your current content, competitors, and SEO performance. We'll identify your unique value proposition and clarify target personas to ensure content resonates with your ideal audience. This foundation enables us to develop a strategic roadmap for your content.",
    icon: "discovery"
  },
  {
    id: 2,
    ...
    description: "I conduct thorough keyword research and competitor analysis to identify the best opportunities for your content to rank and attract qualified traffic.",
    details: "Using advanced SEO tools, I'll analyze search volumes, competition levels, and search intent to identify high-value keyword opportunities. This research informs a strategic content plan that balances quick wins with long-term growth. You'll receive a detailed keyword map organized by topic clusters to guide our content creation.",
    icon: "keyword"
  },
  {
    id: 3,
    ...
    description: "This is where the magic happens! I craft compelling, SEO-optimized content tailored to your brand voice and designed to engage your audience.",
    details: "Each piece is strategically structured with proper heading hierarchies, semantic keyword usage, and engaging calls-to-action. I balance SEO best practices with compelling storytelling that keeps readers engaged and encourages them to take action. All content undergoes quality checks for readability, accuracy, and search optimization.",
    icon: "content"
  },
  {
    id: 4,
    ...
    description: "You get to review the draft content. I welcome feedback and will make revisions to ensure it perfectly aligns with your vision and objectives.",
    details: "My revision process is thorough and collaborative. You'll have the opportunity to review all content before finalization, and I provide up to two rounds of revisions to ensure every detail meets your expectations. This step ensures the content not only performs well for SEO but also accurately represents your brand and messaging.",
    icon: "review"
  },
  {
    id: 5,
    step: "05",
    title: "Delivery & Optimization Tips",
    description: "Once approved, I deliver the final content, often with tips on how to best publish it for maximum SEO impact and ongoing optimization advice.",
    details: "The final deliverable includes publishing guidelines with recommendations for meta descriptions, URL structure, internal linking opportunities, and featured snippet optimization. I also provide suggestions for content promotion and measurement to maximize ROI. Optional ongoing support ensures your content continues to perform well over time.",
    icon: "delivery"
  }
];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" onClick={onClose}>
      ...
      >
        ...
        <div className="mb-4">
          ...
          <p className="text-slate-600 italic">This step is crucial for ensuring we're on the right track to creating content that both resonates with your audience and performs well in search engines.</p>
        </div>
        <button
          onClick={onClose}
